...
def info_tools():
    ...
    jalan('\n %s\x1b[1;92m╠══[%s>%s\x1b[1;92m] Yt       \x1b[1;93m: muhammad syafii.'%(N,H,N))
    jalan('\n %s\x1b[1;92m╠══[%s>%s\x1b[1;92m] Author   \x1b[1;93m: Syafii-XD.'%(N,H,N))
    ...
    jalan('\n %s\x1b[1;92m╠══[%s>%s\x1b[1;92m] Link FB  \x1b[1;93m: https://www.facebook.com/fikritampam305'%(N,H,N))
